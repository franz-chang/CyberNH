...
export CYBERNH_LLM_MODEL="qwen3-vl-2b-instruct"
export CYBERNH_LLM_MODEL_ID="Qwen/Qwen3-VL-2B-Instruct"
export CYBERNH_LLM_LOCAL_DIR="$LLM_DIR/models/Qwen3-VL-2B-Instruct"
...
export CYBERNH_LLM_CLI_SYSTEM_PROMPT="${CYBERNH_LLM_CLI_SYSTEM_PROMPT:-You are Qwen3-VL-2B-Instruct running locally for Cyber-NH. Answer clearly and keep context across turns.}"
